...
class TestInput extends React.Component {
  ...
  handleChange = (e) => {
    this.setState({ value: e.target.value }); //change state of value.
  };

  render() {
    return (
      <InputDate
        onChange={this.handleChange} //binding onchange
        name="value" //init the state's name
        value={this.state.value} //init value from local state.
      />
    );
  }
}
